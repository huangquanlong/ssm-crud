...
var importForm = new Ext.FormPanel({ 
    ...
    buttons : [{
            ...
            handler : function() {
                ...
                var projId = this.ownerCt.ownerCt.projId;
                ...
                if (this.ownerCt.ownerCt.getForm().isValid()){
                    ...
                    if(null == projId || undefined == projId){
                    	Ext.MessageBox.alert("导入错误","导入模型所属项目不明确。");
                        return false;
                    }
                    ...
                    this.ownerCt.ownerCt.getForm().submit({
                        ...
                        success : function(form,o){                    		 
                            ...
                            condi['projId'] = projId;
                            Ext.Ajax.request({
                                url:basepath+"/ImportAction!importModel.json",
                                method:'GET',
                                params:{
                                ...
                                success:function(){
                                    ...
                                    var importFresh = function(){
                                        Ext.Ajax.request({
                                            url:basepath+"/ImportAction!refreshModel.json",
                                            method:'GET',
                                            success:function(a){                                        		
                                                if(a.status == '200' || a.status=='201'){
                                                    ...
                                                    if(res.json.result!=undefined&&res.json.result=='200'){
                                                        ...
                                                        if(proxyStorePS!=undefined){
                                                        	...
                                                        	showSuccessWin2(res.json.curRecordNum);
                                                        }
...
function showSuccessWin2(curRecordNum) {
	importState = true;
	progressWin.removeAll();
