...
Com.yucheng.crm.common.TestCase = Ext.extend(Ext.form.TwinTriggerField, {
	...
	onTrigger2Click : function(){
		...
		if (!_this.reqId || _this.reqId == null || _this.reqId == "") {
			Ext.Msg.alert('提示', '没有需求，不能查询需求测试用例！');
			return false;
		}
		...
		_this.testCaseProxy = new Ext.data.HttpProxy({
			url:basepath+'/testCaseInfo.json?proj_Id='+_this.projId+"&req_id="+_this.reqId
		});
