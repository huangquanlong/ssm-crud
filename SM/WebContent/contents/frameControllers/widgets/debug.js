 ...
 */
Ext.debugImg = {
	warnImg : basepath + '/contents/resource/ext3/resources/images/default/debug/warn.gif',
	errorImg : basepath + '/contents/resource/ext3/resources/images/default/debug/error.gif',
	infoImg : basepath + '/contents/resource/ext3/resources/images/default/debug/info.gif',
	debugImg : basepath + '/contents/resource/ext3/resources/images/default/debug/info.gif'
};
...
Ext.debug.LogPanel = Ext.extend(Ext.Panel, {
    ...
    log : function(){
        var markup = [  '<div style="padding:5px !important;border-bottom:1px solid #ccc;">','<img src='+Ext.debugImg.infoImg+' />',
